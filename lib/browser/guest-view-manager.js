...
const createGuest = function (event, embedderFrameId, elementInstanceId, params) {
...
handleMessage('ELECTRON_GUEST_VIEW_MANAGER_CREATE_AND_ATTACH_GUEST', function (event, embedderFrameId, elementInstanceId, params) {
